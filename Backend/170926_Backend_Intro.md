...
* 调试
   ...
   2. 仔细查看浏览器的报错，你搭建的环境应该默认是会输出php错误到浏览器的页面，没有的话得去设置下。刚开始学，可能对错误信息一脸懵逼，这时候就是考验英语和耐心的时候了，看多了，以后就会快多了。看完错误信息后，还不懂，就可以百度，google，强力安利[stackoverflow](stackoverflow.com),把错误信息粘贴在这里搜索，一般都会有正确答案的。
